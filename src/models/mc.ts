 ...
 * @returns
 */
export const apiWikiCoreScoreRecordGetTop10List = async (params: { type: '2' | '3' | '4' }) => {
 ...
 * @returns
 */
export const apiWikiCoreCatalogueItemGetPage = async (params?: { catalogueId?: string; page?: string; limit?: string }): Promise<CharacterCatalog> => {
